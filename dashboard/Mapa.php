...
$numrs=mysqli_num_rows($consulta2);
...
// SET ContactName = 'Alfred Schmidt', City= 'Frankfurt' WHERE CustomerID = 1;
  ...
  if (mysqli_query($conexion, $sql)) {  
     ...
     if ($numrs==0)
   $boton = "<input type='submit' class='btn btn-primary' value='Agregar' disabled> ";
 else
  $boton = "<input type='submit' class='btn btn-primary' value='Agregar'> ";
                  ...
                  <div class="card card-table-border-none" id="recent-orders">
                    ...
                    <div class="card-body">
                      ...
                      <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" enctype="multipart/form-data">
                          ...
                          <br>
                          <p>Px. Ingresadas</p>
                          <input type="number" name="PxI" class="form-control" placeholder="Personas ingresdas" required>
                          <br>
                          <p>Mesa a asignar</p>
                          <?php echo $table3; ?>
                        </div>
                        <?php if($numrs!=0) : ?>
                         ...
                         <?php endif; ?>
                         <?php if($numrs==0) : ?>
                          <input type="submit" class="btn btn-primary" disabled="true">
                         <?php endif; ?>
                        </form>
